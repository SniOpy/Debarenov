<section class="hero-section" style="height: 60vh; background: var(--anthracite); color: var(--white); display: flex; align-items: center;">
  <div class="container" data-anim="fade-bottom">
    <h1 style="color: var(--white);">Tarifs débarras appartement</h1>
    <p style="color: var(--gris-clair); font-size: var(--text-medium);">Tarifs indicatifs pour le débarras de votre appartement. Devis gratuit et personnalisé.</p>
  </div>
</section>

<!-- ===========================
  INTRO TARIFS APPARTEMENT
=========================== -->
  ...
  <div class="container about-wrapper">
    <div class="about-text">
      ...
      <p class="about-description">
        Le prix d'un débarras d'appartement dépend de plusieurs facteurs : la superficie, le nombre de pièces,
        le niveau d'encombrement, l'étage et l'accessibilité (présence d'ascenseur), le type de mobilier et d'objets
        à évacuer, ainsi que la situation spécifique (succession, déménagement, avant vente, etc.). Chaque appartement
    ...
    <div class="about-image">
      <img src="<?= $BASE_URL ?>assets/img/about/debarras-appartement.jpg" alt="Tarifs débarras appartement" loading="lazy" decoding="async" />
    </div>
  </div>
</section>

<!-- ===========================
  TABLEAUX DE TARIFS APPARTEMENT
=========================== -->
<section class="tarifs-section" data-anim="fade-right">
  <div class="container tarifs-container">
    ...
    <div class="tarifs-header">
      ...
      <h2>Tarifs indicatifs par type d'appartement</h2>
    ...
    <!-- Tableau Débarras Appartement après Succession -->
    <div class="tarif-table-wrapper">
      <table class="tarif-table">
        <thead>
          <tr>
    ...
    <!-- Tableau Débarras Appartement avant Vente -->
    <div class="tarif-table-wrapper">
      <table class="tarif-table">
        <thead>
          <tr>
    ...
    <!-- Tableau Débarras Appartement après Déménagement -->
    <div class="tarif-table-wrapper">
      <table class="tarif-table">
        <thead>
          <tr>
    ...
    <!-- Tableau Débarras Appartement après Sinistre -->
    <div class="tarif-table-wrapper">
      <table class="tarif-table">
        <thead>
          <tr>
    ...
    <div class="tarifs-notes">
      ...
      <ul>
        <li>Les tarifs indiqués sont des fourchettes indicatives pour le débarras d'appartement. Un devis gratuit et personnalisé sera établi après visite sur site.</li>
        <li>Les prix peuvent varier selon l'étage, l'accessibilité (présence d'ascenseur, nombre d'escaliers), le type de mobilier et d'objets à évacuer, ainsi que l'état général de l'appartement.</li>
        ...
        <li>Nos équipes sont formées, assurées et équipées pour tous types d'interventions dans les appartements.</li>
...
<section class="cta-contact-section" data-anim="fade-up">
  <div class="container cta-contact-grid">
    <div class="cta-box">
      ...
      <h2>
        Besoin d'un devis précis pour votre appartement ?
      </h2>
      <p class="cta-text">
        Contactez-nous pour une visite gratuite et un devis personnalisé adapté à votre situation.
        Nous intervenons rapidement et en toute transparence pour le débarras de votre appartement.
      </p>
